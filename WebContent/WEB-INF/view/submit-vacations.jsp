...
<head>
    ...
    <title>Vacations submitted</title>
		...
		<c:choose>
			<c:when test="${submitted eq true}">
				...
				<div class="list-group mt-1">
					<form action="<c:url value="/editVacations"/>" method="POST"
						class="">
						<input type="hidden" name="id" value="${id}" />
						<button type="submit"
							class="btn btn-link list-group-item list-group-item-action">Add
							more vacations for ${shortName}</button>
					</form>
